...
ERROR_CATEGORIES = frozenset(("namespace_create", "forwarding_config", "veth_create", "namespace_move", "bridge_create", "address_config", "link_activate", "route_client_default", "route_server_main", "route_old_policy", "route_candidate_policy", "route_vip_policy", "neighbor_config", "candidate_deactivate", "counter_read", "endpoint_setup", "endpoint_exit", "timeline", "authenticated_events", "garp_announce", "endpoint_runtime", "r8_move_timeout", "r8_move_io", "r8_move_protocol", "worker_internal", "worker_timeout", "worker_exit", "worker_output"))
